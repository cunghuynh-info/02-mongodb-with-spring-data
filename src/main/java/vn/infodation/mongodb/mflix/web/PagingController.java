...
public class PagingController {
    ...
    @GetMapping("/slice")
    public Slice<MovieDetail> slice(MovieSearchCriteria filter,
    ...
    @GetMapping("/scroll")
    public KeysetPage<MovieDetail> scroll(MovieSearchCriteria filter,
    ...
    @GetMapping("/keyset")
    public KeysetPage<MovieDetail> keyset(MovieSearchCriteria filter,
                                          @RequestParam(required = false) String cursor,
                                          @RequestParam(defaultValue = "20") int size) {
    ...
    public Map<String, Object> benchmark(MovieSearchCriteria filter,
                                         @RequestParam(defaultValue = "20") int size,
    ...
    public ExplainSummary explainKeyset(MovieSearchCriteria filter,
                                        @RequestParam(required = false) String cursor,
                                        @RequestParam(defaultValue = "20") int size) {
