...
public class MyCommentsController {
    ...
    @GetMapping("/mine")
    public PageResponse<CommentView> mine(@PageableDefault(size = 20) Pageable pageable) {
    ...
    public List<CommentView> minePostFiltered(@PageableDefault(size = 20) Pageable pageable) {
